...
const translations = {
  en: {
    ...
    expired: 'Expired',
    contactWhatsapp: 'We are waiting for you',
  },
  ar: {
    ...
    expired: 'منتهي',
    contactWhatsapp: 'نحن فى انتظارك'
  }
};
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            >
              <FaGlobe />
              <span>{language === 'ar' ? 'عرض قائمة الطعام' : 'View Your Menu'}</span>
            </Link>
          </div>
        </div>
